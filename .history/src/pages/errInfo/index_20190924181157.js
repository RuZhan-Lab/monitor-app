...
class ErrInfo extends Component {
    ...
    checkCurrentContentHandler = (currentContent) => {
      this.setState({currentContent, visible: true});
    } 
    ...
    render () {
        const columns = [
            ...
            },
            {
              ...
              key: 'content',
              render: (text) => {
                const content = text.length > 50 ? text.slice(0, 50) + '...' : text;
                return <p>{text.slice(0, 50)}</p>
              }
            },
            {
              title: '时间',
